...
class ManageWorkersStub(object):
    """Missing associated documentation comment in .proto file."""
    ...
    def __init__(self, channel):
        ...
        Args:
            channel: A grpc.Channel.
        """
        self.GetWorkersResponse = channel.unary_unary(
                '/task.ManageWorkers/GetWorkersResponse',
                request_serializer=task__pb2.Workers.SerializeToString,
                response_deserializer=task__pb2.WorkersResponse.FromString,
                )


class ManageWorkersServicer(object):
    """Missing associated documentation comment in .proto file."""
...
def add_ManageWorkersServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetWorkersResponse': grpc.unary_unary_rpc_method_handler(
                    servicer.GetWorkersResponse,
                    request_deserializer=task__pb2.Workers.FromString,
                    response_serializer=task__pb2.WorkersResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'task.ManageWorkers', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))


 # This class is part of an EXPERIMENTAL API.
class ManageWorkers(object):
    """Missing associated documentation comment in .proto file."""

    @staticmethod
    def GetWorkersResponse(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/task.ManageWorkers/GetWorkersResponse',
            task__pb2.Workers.SerializeToString,
            task__pb2.WorkersResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
